...
public class NeonController : MonoBehaviour
{
    ...
    GameControllerNeon gameController;
    ...
    void Start()
    {
        ...
        gameController = GameObject.Find("Game Controller").GetComponent<GameControllerNeon>();
    ...
    public void Restart()
    {
        ...
        this.transform.parent.position = new Vector3(0, 3, -90);
    ...
    */
    ...
    {
        if (other.tag == "Fireball" || other.tag == "Robot" || other.tag == "Hellicopter")
        gameController.SignalGameOver();
        /*
